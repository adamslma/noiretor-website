export default function About() {
  return (
    <section className="relative bg-neutral-900 text-amber-100 py-20 sm:py-28 px-4 sm:px-6 md:px-12 lg:px-24">
      <div className="max-w-4xl mx-auto text-center space-y-12">
        <div className="space-y-8">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif tracking-wide text-amber-200">
