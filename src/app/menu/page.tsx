    ...
    <main id="contenu" className="bg-[#eee9df] pt-[4.75rem]">
      <header className="site-container pb-20 pt-20 md:pb-28 md:pt-28">
        <div className="grid gap-10 md:grid-cols-12 md:items-end">
          <div className="md:col-span-8">
            ...
            <h1 className="text-[clamp(4.5rem,11vw,9rem)] leading-[0.85] tracking-[-0.065em]">
              À table.
            </h1>
          </div>
          <div className="md:col-span-4">
            <p className="max-w-md text-sm leading-7 text-[#5e594f]">
              Notre carte évolue selon les arrivages. Les intitulés peuvent changer, l’esprit reste
              le même : des produits nets, des sauces précises et une cuisine généreuse.
            </p>
          </div>
        </div>
      </header>
      ...
      <section className="grid bg-[#191815] text-[#eee9df] lg:min-h-[46rem] lg:grid-cols-[.82fr_1.18fr]">
        <div className="relative min-h-[26rem] overflow-hidden lg:min-h-full">
          ...
          <p className="eyebrow absolute bottom-8 left-8 text-[#eee9df]/70 md:bottom-12 md:left-12">
            La cave · 230 références
          </p>
        </div>
        <div className="flex items-center px-6 py-20 md:px-14 lg:px-20">
          <div className="w-full max-w-2xl">
            ...
            <p className="mt-7 max-w-lg text-sm leading-7 text-[#eee9df]/60">
              Notre cave rassemble des vigneronnes et vignerons proches de leurs sols. Voici
      ...
      <section className="bg-[#e1dacd] py-24 md:py-32">
        <div className="site-container grid gap-10 md:grid-cols-2 md:items-end">
          <div>
            <p className="eyebrow mb-5 text-[#a7793d]">Menus</p>
            <h2 className="text-4xl leading-tight md:text-6xl">
              Le midi en trois temps. Le soir en cinq.
            </h2>
          </div>
          <div className="md:pl-16">
            <div className="border-t border-[#191815]/20">
              <div className="flex justify-between border-b border-[#191815]/20 py-4">
                <span>Déjeuner · trois temps</span>
                <span className="font-mono tabular-nums text-[#a7793d]">49 €</span>
              </div>
              <div className="flex justify-between border-b border-[#191815]/20 py-4">
                <span>Dîner · cinq temps</span>
                <span className="font-mono tabular-nums text-[#a7793d]">89 €</span>
              </div>
            </div>
            <p className="mt-5 text-xs leading-5 text-[#736d63]">
              Allergies et régimes : signalez-les au moment de réserver. Une adaptation végétale est
              possible avec 48 h de préavis.
            </p>
