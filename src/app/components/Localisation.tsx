...
export default function Localisation() {
  return (
    <section className="bg-neutral-900 text-amber-100 py-20 sm:py-28 px-4 sm:px-6 md:px-12 lg:px-24">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 sm:gap-20 lg:gap-24 items-center">
        {/* Bloc texte */}
        ...
        {/* Carte Google Maps */}
        <div className="w-full aspect-[4/3] rounded-lg overflow-hidden shadow-lg border border-amber-100/10">
          <iframe
