      ...
      <div className="mx-auto max-w-4xl space-y-14">
        ...
        <section className="border-l-2 border-[#d0ad74] bg-white/[0.04] p-6 md:p-8">
          ...
          <p className="mt-4 leading-7 text-[#eee9df]/75">
            ...
            « Noir & Or » est un restaurant fictif : ce site n’est associé,
            affilié ou rattaché à aucun établissement de restauration réel.
          </p>
          <p className="mt-4 leading-7 text-[#eee9df]/75">
            Les noms, adresses, coordonnées, menus, prix, horaires et
            disponibilités sont fictifs et fournis uniquement à titre
            d’illustration. Ils ne constituent ni une offre commerciale ni un
        ...
        <section className="space-y-4 border-t border-white/15 pt-8">
          ...
          <p className="leading-7 text-[#eee9df]/75">
            Le concept, la direction artistique, les contenus de démonstration
            et le développement du site sont réalisés par AS Digital.
        ...
        <section className="space-y-4 border-t border-white/15 pt-8">
          ...
          <p className="leading-7 text-[#eee9df]/75">
            ...
            <a href="https://vercel.com" target="_blank" rel="noopener noreferrer" className="underline underline-offset-4 hover:text-[#d0ad74]">vercel.com</a>.
          </p>
        </section>
        ...
        <section className="space-y-4 border-t border-white/15 pt-8">
          ...
          <p className="leading-7 text-[#eee9df]/75">
            Sauf mention contraire, le concept « Noir & Or », les textes, les
            éléments graphiques et l’interface de démonstration ont été créés
            par AS Digital. Les médias appartenant à des tiers restent la
            propriété de leurs titulaires respectifs. Toute utilisation doit
        ...
        <section className="space-y-4 border-t border-white/15 pt-8">
          ...
          <p className="leading-7 text-[#eee9df]/75">
            Ce site ne permet pas de contacter un restaurant, de commander un
            repas ou d’effectuer une réservation réelle. AS Digital ne
            saurait être tenue responsable d’une décision ou d’un déplacement
            fondé sur les contenus fictifs présentés sur cette démonstration.
          </p>
        </section>
